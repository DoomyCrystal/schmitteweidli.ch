...
const FooterItem = ({ blok }) => {
  if (blok.link.cached_url) {
    return (
      <a href={blok.link.cached_url} className="col-span-6 md:col-span-3 group" {...sbEditable(blok)}>
    ...
    return (
      <div className="col-span-6 md:col-span-3 last:md:col-start-10 text-white" {...sbEditable(blok)}>
